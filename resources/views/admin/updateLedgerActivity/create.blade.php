<div class="card-body">
    <div class="row">
        ...
        <div class="col-md-3">
            <button type="button" class="btn btn-success float-right" id="syncLedgerActivity" data-toggle="modal">Update Ledger Activity<i class="fa fa-spinner fa-spin" style="font-size:18px"></i></button>
