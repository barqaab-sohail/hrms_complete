		                            ...
		                            <div class="col-md-8">
		                                <div class="form-group row">
		                                    <div class="col-md-12">
		                                       	...
		                                       	<input type="text"  name="name" value="{{ old('name') }}"  class="form-control excempted" data-validation="required length" data-validation-length="max190" placeholder="Enter Name of Project">
		                                    </div>
		                                </div>
		                            </div>
