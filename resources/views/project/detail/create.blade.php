                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <label class="control-label text-right">Sub Projects</label>
                                                <select name="sub_projects" class="form-control selectTwo">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" hidden name="project_no" id="project_no" data-validation=" required length" readonly data-validation-length="max7" value="{{ old('project_no') }}" class="form-control">
