                    ...
                    <div class="col-md-8">
                        <div class="form-group row">
                            <div class="col-md-12">
                               	...
                               	<input type="text"  name="name" value="{{ old('name', $data->name??'') }}"  class="form-control exempted" data-validation="required length" data-validation-length="max190" placeholder="Enter Name of Project">
                            </div>
                        </div>
                    </div>
