        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="positionForm" name="positionForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="control-label">Nominated Person<span class="text_requried">*</span></label>
                        <input type="text" id="nominated_person" name="nominated_person" value="{{ old('nominated_person') }}" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label text-right">Total Man Month<span class="text_requried">*</span></label><br>
