      ...
      <div class="modal-body">
        ...
        <form id="staffForm" name="staffForm" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <input type="text" name="to" id="to" value="{{ old('to') }}" class="form-control date_input" readonly>
            <br>
            <i class="fas fa-trash-alt text_requried"></i>
          </div>
          <div class="form-group">
            <label class="control-label text-right">Working<span class="text_requried">*</span></label>
            <select name="working_as" id="working_as" class="form-control selectTwo" data-validation="required">
              <option></option>
