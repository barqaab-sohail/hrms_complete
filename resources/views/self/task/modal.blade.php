                  ...
                  <div class="form-body">
                    ...
                    <div class="form-group row">
                      <div class="col-md-12">
                        ...
                        <input type="text" id="completion_date" name="completion_date" value="{{ old('completion_date') }}" class="form-control date_input"  placeholder="Enter Task Completion Date" data-validation="required"  readonly>
                    ...
                    <div class="form-group row">
                      <div class="col-md-12">
                        ...
                        <input type="text" id="target_completion" name="target_completion" value="{{ old('target_completion') }}" class="form-control date_input"  placeholder="Enter Target 
                        Completion Date" data-validation="required"  readonly>
                    ...
                    <div class="form-group row">
                      <div class="col-md-12">
                        ...
                        <input type="text" name="remakrs" value="{{ old('remakrs') }}" class="form-control"  placeholder="Enter Remarks if any" data-validation="required" >
