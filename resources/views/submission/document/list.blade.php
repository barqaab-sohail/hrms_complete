				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
						 ...
						 <a class="btn btn-info btn-sm" id="editDocument" href="{{route('submissionDocument.edit',$documentId->id)}}" data-toggle="tooltip" data-original-title="Edit"> <i class="fas fa-pencil-alt text-white "></i></a>
