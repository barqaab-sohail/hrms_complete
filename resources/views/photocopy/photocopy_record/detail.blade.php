    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="recordForm" name="recordForm" action="{{route('photocopy_record.store')}}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label text-right">Black Reading</label>
                                <input type="number" name="reading" id="reading" value="{{ old('reading') }}"
                                    class="form-control">
                            </div>
                        </div>
						...
						<div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label text-right">Color Reading</label>
                                <input type="number" name="color_reading" id="color_reading" value="{{ old('color_reading') }}"
                                    class="form-control">
                            </div>
                        </div>
						@endif
...
<div class="row justify-content-end">
    <div class="col-lg-12 reducedCol">
        <div class="card">
            <div class="card-body">
                <button type="button" class="btn btn-success float-right" id="createRecordy" data-toggle="modal">Add
                    Record</button>
                    ...
                    <table id="myTable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="width:10%">Black Reading</th>
                                @if($photocopy->type=='Color')
                                <th style="width:10%">Color Reading</th>
                                @endif
    ...
    $(function() {
        ...
        $('body').unbind().on('click', '.editRecord', function() {
            ...
            $.get("{{ url('photocopy_record') }}" + '/' + record_id + '/edit', function(data) {
				...
				$('#color_reading').val(data.color_reading);
