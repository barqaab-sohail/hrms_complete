	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="photocopyForm" name="photocopyForm" action="{{route('photocopy.store')}}" class="form-horizontal">
...
<div class="card">
	<div class="card-body">
		<button type="button" class="btn btn-success float-right" id="createPhotocopy" data-toggle="modal">Add Photocopy</button>
