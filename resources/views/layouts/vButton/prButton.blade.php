<div class="btn-group-vertical" role="group" aria-label="vertical button group" style="width: 100%;">
          ...
          <br>
            ...
            <a type="submit" role="button" id="addDocument" href="{{route('projectDocument.create')}}" class="btn btn-info" {Request::is('hrms/projectDocument/create')?'style=background-color:#737373':''}}>Position</a>
