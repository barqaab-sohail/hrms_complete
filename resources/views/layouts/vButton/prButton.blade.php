<div class="btn-group-vertical" role="group" aria-label="vertical button group" style="width: 100%;">
          ...
          <br>
            ...
            @endif
            <a type="submit" role="button" id="addConsultancyCost" href="{{route('projectConsultancyCost.create')}}" class="btn btn-info" {Request::is('hrms/projectConsultancyCost/create')?'style=background-color:#737373':''}}>Consultancy Cost</a>
