<div class="dropdownSubMenue">
    ...
    <span id="dropdownSubMenueText" style="font-size:20px"></span>
      ...
      <div class="dropdown-menu" role="group" aria-labelledby="dropdownMenuButton" style="width: 100%;">
            ...
            @can('Super Admin')   
            <a type="submit" id="addUserLogin" style="color:white" role="button" href="{{route('userLogin.edit',session('hr_employee_id'))}}" class="dropdown-item btn btn-success " {{Request::is('hrms/userLogin/')?'style=background-color:#737373':''}}>User Login Detail</a> 
            @endcan
