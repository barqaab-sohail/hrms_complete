<div class="dropdownSubMenue">
	...
	<div class="dropdown-menu" role="group"  aria-labelledby="dropdownMenuButton" style="width: 100%;">   
	        ...
	        <a type="submit" role="button" id="addPartner" href="{{route('submissionPartner.list',session('submission_id'))}}" style="color:white" class="dropdown-item btn btn-success " {{Request::is('hrms/submission/partner')?'style=background-color:#737373':''}}>Partner Detail</a>
