<div class="card-body">
    ...
    <button type="button" class="btn btn-success float-right" id="createCompany" data-toggle="modal">Add Company</button>
    <br>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="companyForm" name="companyForm" action="{{route('employeeCompany.store')}}" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <select id="partner_id" name="partner_id" data-validation="required" class="form-control selectTwo">
                            <option></option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="end_date" id="end_date" value="{{ old('end_date') }}" class="form-control date_input" data-validation="required" readonly>
                        <br>
                        <i class="fas fa-trash-alt text_requried"></i>
                    </div>
                    <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        $(function() {
            ...
            $('body').unbind().on('click', '.editCompany', function() {
                ...
                $('#json_message_modal').html('');
                $.get("{{ url('hrms/employeeCompany') }}" + '/' + employee_company_id + '/edit', function(data) {
            ...
            $('body').on('click', '.deleteCompany', function() {
                ...
                if (con) {
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('employeeCompany.store') }}" + '/' + employee_company_id,
                        data: {
                            hrEmployeeId: $("#hr_employee_id").val()
                        },
                        success: function(data) {
