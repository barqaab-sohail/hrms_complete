						...
						@foreach($hrExits as $hrExit)
							<tr>
								...
								<td>{{$hrExit->reason}}</td>
								 ...
								 <a class="btn btn-info btn-sm" id="editContact" href="{{route('exit.edit',$hrExit->id)}}" data-toggle="tooltip" data-original-title="Edit"> <i class="fas fa-pencil-alt text-white "></i></a>
								 </td>
								 <td class="text-center">
								 @can('hr edit record')
