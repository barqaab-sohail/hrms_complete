    ...
    <div class="card-body">
        <form id= "formAdditionalInformation" method="post" class="form-horizontal form-prevent-multiple-submits" action="{{route('additionalInformation.update',$id)}}" enctype="multipart/form-data">
        @method('PATCH')
        @csrf
            <div class="form-body">
