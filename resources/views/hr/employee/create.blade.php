...
@section('Heading')
<h3 class="text-themecolor">Add New Employee</h3>
@stop
@section('content')
<div class="row">
    <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div style="margin-top:10px; margin-right: 10px;">
                        <button type="button" onclick="window.location.href='{{route('employee.index')}}'"
                            class="btn btn-success float-right" data-toggle="tooltip" title="Back to List">List of
                            Employees</button>
                    </div>

                    <div class="card-body">
                        <form id="formEmployee" method="post" class="form-horizontal form-prevent-multiple-submits"
                            ...
                            <div class="form-body">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="husband_name" value="{{ old('husband_name') }}"
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="date_of_birth" name="date_of_birth"
                                                    value="{{ old('date_of_birth') }}" class="form-control date_input"
                                                    data-validation="required" readonly>

                                                <br>
                                                @can('hr edit record')<i
                                                    class="fas fa-trash-alt text_requried"></i>@endcan
                                            </div>
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <label class="control-label text-right">CNIC<span
                                                        class="text_requried">*</span></label>
                                                <input class="form-check-input" type="checkbox"
                                                    id="disable_cnic_validation" name="disable_cnic_validation">
                                                ...
                                                <input type="text" name="cnic" id="cnic" pattern="[0-9.-]{15}"
                                                    title="13 digit without dash" value="{{ old('cnic') }}"
                                                    class="form-control" data-validation="required"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="cnic_expiry" name="cnic_expiry"
                                                    value="{{ old('cnic_expiry') }}" class="form-control date_input"
                                                    data-validation="required" readonly>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <label class="control-label text-right">Gender<span
                                                        class="text_requried">*</span></label>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <label class="control-label text-right">Marital Status<span
                                                        class="text_requried"
                                                        data-validation="required">*</span></label>

                                                <select name="marital_status_id" class="form-control selectTwo"
                                                    data-validation="required">
                                                    <option value=""></option>
                                                    @foreach($maritalStatuses as $maritalStatus)
                                                    <option value="{{$maritalStatus->id}}"
                                                        {{(old("marital_status_id")==$maritalStatus->id? "selected" : "")}}>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <label class="control-label text-right">Religion<span
                                                        class="text_requried">*</span></label>

                                                <select name="religion_id" class="form-control selectTwo"
                                                    data-validation="required">
                                                    <option value=""></option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                <button type="submit"
                                                    class="btn btn-success btn-prevent-multiple-submits"><i
                                                        class="fa fa-spinner fa-spin" style="font-size:18px"></i>Add
                                                    Employee</button>
                                            </div>
                                        </div>
                                    </div>
    ...
    function submitFormAjax(form, url, reset = 0) {
        ...
        $.ajaxPrefilter(function(options, originalOptions, xhr) { // this will run before each request
            var token = $('meta[name="csrf-token"]').attr(
                'content'); // or _token, whichever you are using

            if (token) {
                return xhr.setRequestHeader('X-CSRF-TOKEN',
                    token); // adds directly to the XmlHttpRequest Object
            }
        });
        ...
        $.ajax({
            ...
            error: function(jqXHR, textStatus, errorThrown) {
                ...
                var test = jqXHR
                    .responseJSON // this object have two more objects one is errors and other is message.
