                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <select id="pr_detail_id" name="pr_detail_id" class="form-control selectTwo">
                                ...
                                <option value="{{$project->id}}" {{(old("pr_detail_id", $data->project->pr_detail_id??'')==$project->id? "selected" : "")}}>{{$project->project_no}} - {{$project->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <select id="hr_manager_id" name="hr_manager_id" class="form-control selectTwo">
                                ...
                                <option value="{{$manager->id}}" {{(old("hr_manager_id",$data->hrManager->hr_manager_id??'')==$manager->id? "selected" : "")}}>{{$manager->employee_no}} - {{$manager->first_name. ' '.$manager->last_name .' - '}}{{$manager->employeeCurrentDesignation->name??''}}</option>
                                @endforeach
                            </select>
