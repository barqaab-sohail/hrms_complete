                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <select id="hr_manager_id" name="hr_manager_id" class="form-control selectTwo">
                                ...
                                <option value="{{$manager->id}}" {{(old("hr_manager_id",$data->hrManager->hr_manager_id??'')==$manager->id? "selected" : "")}}>{{$manager->employee_no}} - {{$manager->first_name. ' '.$manager->last_name .' - '}}{{$manager->employeeDesignation->last()->name??''}}</option>
                                @endforeach
                            </select>
