    ...
    <div class="card-body">
        <form id= "formContact" method="post" class="form-horizontal form-prevent-multiple-submits" action="{{route('emergency.update',session('hr_employee_id'))}}" enctype="multipart/form-data">
        @method('PATCH')
        @csrf
            <div class="form-body">
                    
                <h3 class="box-title">Emergency Detail</h3>
    ...
    1                            <input type="text" name="relation" value="{{ old('relation',$data->relation??'') }}" class="form-control" data-validation="required length"  data-validation-length="max190">
