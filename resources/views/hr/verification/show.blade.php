...
<body>
    ...
    <div class='container-fluid'>
        <div class="card mx-auto col-md-12 col-10 mt-5">
            ...
            @else
            <img class='mx-auto img-thumbnail' src="{{asset('Massets/images/default.png')}}" width="150"
                height="auto" />
            @endif
            <div class="card-body text-center mx-auto">
                <div class='cvp'>
                    ...
                    <h5 class="card-title font-weight-bold" id="emp_des">CNIC/Passport: {{$data->cnic??''}}</h5>
                    <h5 class="card-title font-weight-bold" id="emp_des">Emergency No:
                        {{$data->hrEmergency->mobile??''}}</h5>
                    <h5 class="card-title font-weight-bold" id="emp_status">
                        {{$data->hr_status_id == 'Active'?'Current Status: Active':'Current Status: Inactive'}}</h5>
                    <br>
