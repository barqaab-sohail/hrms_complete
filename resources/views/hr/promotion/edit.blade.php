                             ...
                             <div class="form-group row">
                                 <div class="col-md-12">
                                     ...
                                     <select id="hr_manager_id" name="hr_manager_id" class="form-control selectTwo">
                                         ...
                                         <option value="{{$manager->id}}" {{(old("hr_manager_id",$data->hrManager->hr_manager_id??'')==$manager->id? "selected" : "")}}>{{$manager->first_name. ' '.$manager->last_name .' - '}}{{$manager->employeeCurrentDesignation->name??''}}</option>
                                         @endforeach
                                     </select>
                         ...
                         <div class="col-md-8">
                             <div class="form-group row">
                                 <div class="col-md-12">
                                     ...
                                     <input type="text" name="remarks" id="forward_slash" value="{{ old('remarks',$data->remarks??'') }}" class="form-control exempted" data-validation="required length" data-validation-length="max190" placeholder="Enter Remarks if any">
