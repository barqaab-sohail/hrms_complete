...
<style>
    ...
    /* Style for content type toggle buttons */
    #contentTypeToggle .btn {
        color: #007bff;
        border-color: #007bff;
        background-color: #f8f9fa;
    }
    
    #contentTypeToggle .btn.active, 
    #contentTypeToggle .btn:hover {
        color: #fff;
        background-color: #007bff;
        border-color: #007bff;
    }
    
    #contentTypeToggle .btn:focus {
    ...
    <div class="card-body">
        ...
        <form id="experienceLetterForm" method="POST" action="{{ route('experience-letters.preview') }}">
            ...
            <div class="form-group">
                ...
                <div class="btn-group btn-group-toggle" data-toggle="buttons" id="contentTypeToggle">
...
<script>
    ...
    function initTinyMCE() {
        tinymce.init({
            ...
            content_style: 'body { font-family: "DejaVu Sans", Arial, sans-serif; font-size: 14px; }'
        });
    }
    ...
    $(document).ready(function() {
        ...
        $('#experienceLetterForm').on('submit', function(e) {
            ...
            // Update TinyMCE content to textarea before form submission
