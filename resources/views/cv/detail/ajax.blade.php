                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <select name="speciality_name[]" id="speciality_name" class="form-control required">
                                ...
                                <option value="{{$specialization->id}}" @if($specialization->id == $speciality->cv_specialization_id) selected="selected" @endif>{{$specialization->name}}</option>
                                @endforeach
                            </select>
                            <br>
                            @can('cv edit record')
                    ...
                    <div class="form-group row">
                        <div class="col-md-12 ">
                            ...
                            <select name="discipline_name[]" data-validation="required" id=discipline_name class="form-control required">
                                ...
                                <option value="{{$discipline->id}}" @if($discipline->id == $speciality->cv_discipline_id) selected="selected" @endif
                    ...
                    <div class="form-group row">
                        <div class="col-md-12 ">
                            ...
                            <select name="stage_name[]" data-validation="required" id=stage_name class="form-control required">
                                ...
                                <option value="{{$stage->id}}" @if($stage->id == $speciality->cv_stage_id) selected="selected" @endif
                                    >{{$stage->name}}</option>
                    ...
                    <div class="form-group row">
                        <div class="col-md-8">
                            ...
                            <select name="year[]" id="field_year" class="form-control required">
                                ...
                                <option value="">&nbsp;</option>
                                @for ($i = 1; $i <= 50; $i++) <option value="{{$i}}" @if($i==$speciality->year) selected="selected" @endif
                                    >{{ $i }}</option>
                                    @endfor
                            </select>
