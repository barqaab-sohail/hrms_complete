...
{
    $managements = array('testing', 'Chief Executive Officer', 'General Manager (W&C)', 'General Manager (Power)', 'Manager Finance', 'Deputy Manager HR&A', 'Contract Expert');
