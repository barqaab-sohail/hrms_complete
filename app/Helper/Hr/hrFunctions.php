...
function employeeDesignationArray()
{
	...
	$designationArray = array_merge($managements, $projectManagers, $seniorEngineers, $juniors, $support, $utilityPerson);
