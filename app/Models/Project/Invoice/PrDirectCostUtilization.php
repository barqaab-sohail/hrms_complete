...
class PrDirectCostUtilization extends Model implements Auditable
{
    ...
    protected $fillable = ['pr_detail_id', 'direct_cost_detail_id', 'month_year', 'amount', 'remarks'];
    ...
    public function directCostDescription()
    {
        return $this->hasOneThrough(
            'App\Models\Project\DirectCostDescription', //Final Model HrDocumentName
            'App\Models\Project\Invoice\DirectCostDetail', //Model Through Access Final Model (Immediate Model)
            'direct_cost_detail_id',                            //Forein Key in Immediate Model of This Model
