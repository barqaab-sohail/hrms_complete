        ...
        if ($projectLevel > 1) {
            ...
            foreach ($levelOnes as $levelOne) {
                ...
                if ($leveltwoSum === 0) {
                    ...
                    $customData1->push([
                        ...
                        'name' => $levelOne->name,
                        'weightage' => round($totalWeightageProgressLevel1, 2),
                ...
                foreach ($levelTwos as $levelTwo) {
                    ...
                    if ($levelTwoSum === 0) {
                        ...
                        $customData1->push([
                            ...
                            'name' => $levelTwo->name,
                            'weightage' =>  round($levelTwo->weightage, 2),
                    ...
                    foreach ($levelThrees as $levelThree) {
                        ...
                        $customData1->push([
                            ...
                            'weightage' =>  round($levelThree->weightage, 2),
            ...
            foreach ($progressActivities as $progressActivity) {
                ...
                $customData1->push([
                    ...
                    'weightage' =>  round($progressActivity->weightage, 2),
