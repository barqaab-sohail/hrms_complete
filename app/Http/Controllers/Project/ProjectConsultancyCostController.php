...
class ProjectConsultancyCostController extends Controller
{
    ...
    public function show($prDetailid)
    {
        ...
        $view =  view('project.consultancyCost.create', compact('prCostTypes', 'prDetail'))->render();
    ...
    public function create(Request $request)
    {
        ...
        if ($request->ajax()) {
            $data = PrCost::where('pr_detail_id', $request->prDetailId)->latest()->with('prCostType')->get();
