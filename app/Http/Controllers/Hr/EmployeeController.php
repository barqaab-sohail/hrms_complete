...
class EmployeeController extends Controller
{
    ...
    foreach ($employees as $employee){
        if($employee->hrAppointment){
            ...
            $input['employee_project_id']= $employee->hrAppointment->pr_detail_id;
            $input['hr_letter_type_id']= $employee->hrAppointment->hr_letter_type_id;
            $input['employee_manager_id']= $employee->hrAppointment->hr_manager_id;
            $input['employee_designation_id']= $employee->hrAppointment->hr_designation_id;
            $input['employee_department_id']= $employee->hrAppointment->hr_department_id;
            $input['employee_salary_id']= $employee->hrAppointment->hr_salary_id;
            $input['employee_office_id']= $employee->hrAppointment->office_id;
            ...
            $input['employee_grade_id']= $employee->hrAppointment->hr_grade_id;
            $input['employee_category_id']= $employee->hrAppointment->hr_category_id;
