...
class CreatePrConsultancyCostMmTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pr_consultancy_cost_mms', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->id();
    ...
    {
        Schema::dropIfExists('pr_consultancy_cost_mms');
    }
}
